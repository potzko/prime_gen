/*
   small prime sieve I made,
   will generate 100_000_000 in slightly under 10 seconds on my computer
   or 1_000_000_000 in about 130 seconds
   use --release this code gets optimized very nicly
   this code uses segmented sieve of eratosthenes
